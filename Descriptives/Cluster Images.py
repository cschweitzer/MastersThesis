...
#%%
fig2 = plt.figure(2)
plt.scatter(clusters.iloc[:,0], clusters.iloc[:,1])
...
plt.savefig("../Outputs/Plots/pca_vs_clustering_4_5_withnoise.png")
plt.show()
...
ax.set_ylabel(r'Component 2', fontsize=15)
ax.set_zlabel(r'Component 3', fontsize=15)
plt.savefig("../Outputs/Plots/pca_vs_clustering_4_5_nonoise.png")
plt.show()
...
ax.set_ylabel(r'Component 2', fontsize=15)
ax.set_zlabel(r'Component 3', fontsize=15)
plt.savefig("../Outputs/Plots/pca_vs_clustering_kmeans8_3dall.png")
plt.show()
...
ax.set_ylabel(r'Component 2', fontsize=15)
ax.set_zlabel(r'Component 3', fontsize=15)
plt.savefig("../Outputs/Plots/pca_vs_clustering_kmeans8_3dremoveout.png")
plt.show()
